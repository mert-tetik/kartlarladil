...
export default async function ScheduledPostsRoute() {
  await requireDeveloperAdmin("/content-automation/scheduled-posts");
  return <SocialContentStudioPage view="scheduled-posts" />;
}
