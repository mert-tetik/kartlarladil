...
export default async function ContentAutomationTableRoute() {
  await requireDeveloperAdmin("/content-automation/automations");
  return <SocialContentStudioPage view="automations" />;
}
