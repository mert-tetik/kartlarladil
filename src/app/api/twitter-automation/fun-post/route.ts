...
const CONTENT_RULES = {
  ...
  "relatable-learner": "Write one short, funny, highly relatable post about the selected learning language or the experience of learning it. Follow the supplied creative direction and invent a concrete, fresh situation around it. On consecutive generations, change the situation, joke structure, punchline, and wording completely rather than paraphrasing a familiar language-learning joke. Do not default to generic jokes about forgetting a word, Duolingo-style streaks, or a brain that stops working unless the supplied direction specifically calls for one. Write in the selected native language's natural, current Gen Z internet voice. Every post must include at least one authentic local Gen Z or online-slang expression and at least one locally natural shortened word or abbreviation. For Turkish, examples include 'yapÄ±yo' instead of 'yapÄ±yor' or 'bi' instead of 'bir'. Do not force English slang or invented abbreviations into another language. Be deliberately relaxed with punctuation and grammar, as in a real casual post, while keeping the meaning coherent. When showing laughter or being overwhelmed, use ğŸ˜­ and/or ğŸ’€ rather than laughing-face emojis. Keep the humour warm, specific, and recognisably human, never mean or corporate. No FoxiesDeck marketing.",
