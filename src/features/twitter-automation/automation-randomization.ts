...
export const AUTOMATION_GENERATOR_OPTIONS: Record<AutomationContentType, ReadonlyArray<{ value: string; label: string }>> = {
  ...
  image: [
    ...
    { value: "vocabulary-carousel", label: "Vocabulary Carousel" },
    { value: "tier-progression-carousel", label: "A1 to C1 Carousel" },
    ...
    { value: "self-mini-quiz", label: "Mini Quiz (Self)" },
    { value: "self-false-friends", label: "False Friends (Self)" },
    { value: "self-daily-challenge", label: "Daily Challenge (Self)" },
    { value: "self-vocabulary-progression", label: "Beginner to Advanced (Self)" },
    { value: "self-example-sentences", label: "Example Sentences (Self)" },
  ],
  video: [
    { value: RANDOM_GENERATOR, label: "Random" },
    ...
    { value: "marketing-dialogue-video", label: "FoxiesDeck Dialogue Video" },
    { value: "learning-dialogue-video", label: "Learning Dialogue Video" },
    { value: "tier-progression-video", label: "A1 to C1 Learning Video" },
    { value: "vocabulary-quiz-video", label: "Vocabulary Quiz Video" },
    { value: "sentence-check-video", label: "Sentence Check Video" },
    { value: "sentence-translation-video", label: "Sentence Translation Video" },
    ...
    { value: "music-self-mini-quiz", label: "Mini Quiz (Self) Music Video" },
    { value: "music-self-false-friends", label: "False Friends (Self) Music Video" },
    { value: "music-self-daily-challenge", label: "Daily Challenge (Self) Music Video" },
    { value: "music-self-vocabulary-progression", label: "Beginner to Advanced (Self) Music Video" },
    { value: "music-self-example-sentences", label: "Example Sentences (Self) Music Video" },
  ],
};
