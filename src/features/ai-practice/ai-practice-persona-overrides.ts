...
export const AI_PRACTICE_SUMMARY_OVERRIDES: Partial<Record<string, Record<LocaleCode, string>>> = {
  ...
  "study-buddy": {
    tr: "İçe dönük, gotik, mesafeli",
    en: "Guarded, gothic, distant",
    de: "Verschlossen, gotisch, distanziert",
    ru: "Замкнутая, готичная, отстранённая",
    fr: "Réservée, gothique, distante",
    es: "Reservada, gótica, distante",
    it: "Riservata, gotica, distaccata",
    pt: "Reservada, gótica, distante",
    nl: "Gesloten, gotisch, afstandelijk",
    pl: "Zamknięta, gotycka, zdystansowana",
    ar: "منغلقة وغوثية وبعيدة",
    ja: "内向的で、ゴシックで、距離がある",
    ko: "내성적이고 고딕하며 거리감 있는",
    "zh-CN": "内向、哥特、疏离",
  },
};
